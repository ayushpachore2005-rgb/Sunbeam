...
INSERT INTO courses (course_id, course_name, description, fees, start_date, end_date, video_expiry_days) VALUES
(8, 'gen ai', 'Core Java course', 6000, '2025-12-20', '2026-01-20', 30);
...
INSERT INTO users (email, password, role) VALUES
('jack@gmail.com', 'jack123', 'student');
...
select s.reg_no,s.name,c.course_name,s.email,s.course_id,s.profile_pic,s.mobile_no from students s join courses c
on s.course_id=c.course_id;

-- q3--
SELECT * FROM students s join courses c
on s.course_id=c.course_id
having email="john@gmail.com";

-- q4--
select * from  courses c join videos v 
on c.course_id=v.course_id 
join students 
on students.course_id=c.course_id
where email="jack@gmail.com"
AND 
date_add(v.added_at, INTERVAL c.video_expiry_days DAY) >= curdate();
;
